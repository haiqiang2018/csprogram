...
function checkColor(color) {
    ...
    if (color != "default") {
        ...
        $(".flowList.for-cur,.flowListBox .for-cur em").css({ "background-color": "#3AE7BC"});
...
function loadFlowDiv(index){ 
 ...
 $("#iList").html(strVar);*/
 if(index==1){$("#contA").removeClass("contentList");$("#contA").siblings().addClass("contentList");$("#btnNext").hide();}
 if(index==2){$("#contB").removeClass("contentList");$("#contB").siblings().addClass("contentList"); $("#btnNext").show();}
 if(index==3){$("#contC").removeClass("contentList");$("#contC").siblings().addClass("contentList");$("#btnok").hide();}
